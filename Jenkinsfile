pipeline {
	...
	stages {
		...
		steps{
		ansiblePlaybook becomeUser: 'ubuntu', credentialsId: 'Test-Server', disableHostKeyChecking: true, installation: 'ansible', inventory: '/home/ubuntu/deployserver.inv', playbook: '/home/ubuntu/ansible-playbook.yml'
	}
	}
	}
}
